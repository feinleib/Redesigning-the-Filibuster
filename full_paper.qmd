...
<!-- 
* measuring the parameters (alpha, betas, C's)
* considering more filibuster rules?
* empirical evidence for the coalition sizes I predict
* becoming more certain of the effects of each rule
* addressing the issues in "Buying Supermajorities"
  * (want to be a couple votes above the threshold)
-->
The primary extension needed to corroborate my findings is empirical evidence for my predictions. This starts with structurally estimating the parameters of the model. @kogerFilibusteringPoliticalHistory2010 performed this sort of estimation in response to the findings of @wawroFilibusterObstructionLawmaking2006. Similar work is needed to evaluate this expanded model. Empirical work will make the predicted effects of different cloture rules more certain.
