...
The modern practice of the filibuster is the product of a long history of evolutions and changes to the Senate's rules and norms. 

* Original Senate: Senate Code, plus previous question motion
* 1806: previous question rule dropped
* 1841: Calhoun's filibuster
* 1917: introduction of Rule XXII (two-thirds of present+voting sens)
...
Pivotal politics theory underscores the increased impact of the filibuster on the Senate over the past 50 years. Among the filibuster pivot and the veto pivot, the filibuster pivot has grown in relative importance since the 1970s [@grayUnpackingPivotalPolitics2017], when the use of the cloture rule skyrocketed, as shown in @fig-cloture-graph below [@unitedstatessenateSenateActionCloture2024].
