...
pivotal_votes <- s_mem_failed_cvotes |> 
  left_join(s_failed_cvotes |> 
              select(congress, rollnumber, threshold, votes_needed, nominate_spread_dist, bill_number, vote_desc),
            by = c("congress", "rollnumber")) |> 
  group_by(congress, rollnumber, bill_number, vote_desc, threshold, votes_needed) |> 
...
I multiply the pivotal vote's probability by the DW-NOMINATE spread of the probabilities to estimate the distance equival.
